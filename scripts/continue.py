...
parser.add_argument("meta", default=META_PATH, type=str, help="path to metadata file", nargs="?")
parser.add_argument("weights", default=WEIGHT_PATH, type=str, help="path to weights", nargs="?")
